...
static int SetAppRun(PUserContext, int, char**);

const UserApp SetApp = { "set", SetAppRun, "[name [value]]", "Displays variable(s) or sets an environment variable" };

int SetAppRun(PUserContext Context, int argc, char** argv)
{
	int rc = 0;
	int i;
