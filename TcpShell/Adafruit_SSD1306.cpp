...
Adafruit_SSD1306::Adafruit_SSD1306(pi2c I2CHandle)
...
void Adafruit_SSD1306::ssd1306_command(uint8_t c) { 
	...
	i2c_master_transmit(_i2chandle, _i2caddr, &control, 1);
	i2c_master_transmit(_i2chandle, _i2caddr, &c, 1);
	// Wait for the HAL command to exit.
}
...
void Adafruit_SSD1306::display(void) 
{
	...
	for(uint16_t i = 0 ; i < (SSD1306_LCDWIDTH*SSD1306_LCDHEIGHT / 8) ; i++) {
		...
		for (uint8_t x = 0; x < 16; x++) {
			i2c_master_transmit(_i2chandle, _i2caddr, &buffer[i], 1);
			i++;
		}
		i--;
	}
